          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {popularCourses.map((course) => (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-black bg-opacity-75 p-4 transition-opacity flex flex-col justify-center space-y-3 ${
                    hoveredPopularCourse === course.id
                      ? "opacity-100"
                      : "opacity-0"
                  }`}
                >
                  ...
                  <p className="text-sm text-white">
                    {course.duration} total hours · {course.lectureCount}{" "}
                    lectures · All Levels
                  </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
              {filteredCourses.map((course) => (
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 bg-black bg-opacity-75 p-4 transition-opacity flex flex-col justify-center space-y-3 ${
                      hoveredFilteredCourse === course.id
                        ? "opacity-100"
                        : "opacity-0"
                    }`}
                  >
