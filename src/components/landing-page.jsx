        ...
        <div className="flex items-center space-x-4">
          <form onSubmit={handleSearch} className="hidden md:flex items-center">
            <input
              ...
              className="w-64 px-4 py-2 rounded-l-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
                    ...
                    <div className="absolute inset-0 bg-white bg-opacity-90 p-4 rounded-lg flex flex-col justify-between overflow-auto transition-opacity duration-300">
                      ...
                      <div className="mt-4 space-y-2">
                        ...
                        <button
                          ...
                          className="w-full bg-blue-500 hover:bg-blue-600 text-white text-sm font-bold py-2 px-4 rounded transition-colors duration-300"
                        >
                          More Info
                        </button>
                      </div>
    ...
    <footer className="bg-blue-200 text-black py-8">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl"> {/* Update 4 */}
        <div className="flex flex-col lg:flex-row justify-between items-start mb-6"> {/* Update 5 */}
          <div className="flex flex-col items-center lg:items-start mb-6 lg:mb-0 w-full lg:w-2/3 text-center lg:text-left"> {/* Update 5 */}
            <Image 
              src="/TransparentLogo.png"
