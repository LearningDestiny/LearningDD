...
const EventDetails = ({ id }) => {
  ...
  useEffect(() => {
    const eventId = Number(id); // Convert id to a number if necessary
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-900 via-indigo-900 to-gray-900 text-gray-100">
      <div className="container mx-auto py-12 px-6 flex-grow">
        {/* Event Header */}
        <div className="flex flex-col md:flex-row items-start  md:justify-start text-center md:text-left border-b border-gray-700 pb-8">
